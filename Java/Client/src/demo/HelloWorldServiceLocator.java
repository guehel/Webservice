...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements demo.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:8080/DemoWSOA/services/HelloWorld";
    ...
    public demo.HelloWorld getHelloWorld() throws javax.xml.rpc.ServiceException {
    ...
    public demo.HelloWorld getHelloWorld(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            demo.HelloWorldSoapBindingStub _stub = new demo.HelloWorldSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (demo.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                demo.HelloWorldSoapBindingStub _stub = new demo.HelloWorldSoapBindingStub(new java.net.URL(HelloWorld_address), this);
                _stub.setPortName(getHelloWorldWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://demo", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://demo", "HelloWorld"));
        }
